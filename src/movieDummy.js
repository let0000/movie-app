export const dummy = {
  dates: { maximum: "2023-02-25", minimum: "2023-01-08" },
  page: 1,
  results: [
    {
      adult: false,
    ...
    },
    {
      ...
      original_title: "TÁR",
      overview:
        "전 세계적으로 인정받는 이 시대 최고의 지휘자이자 베를린 필하모닉 최초의 여성 수석 지휘자로 커리어의 정점에 서 있는 리디아 타르. 말러 교향곡 녹음 음반 발매와 자서전 발간을 동시에 앞두고 있는 그에게 자신이 설립한 아코디언 재단의 회원이었던 크리스타로부터 이상한 이메일이 도착하고, 이후 크리스타의 자살 소식을 접한 그는 불안에 사로잡히게 되는데... 무대를 장악하는 마에스트로, 욕망을 불태우는 괴물, 베를린 필하모닉 최초의 여성 지휘자 리디아 타르. 이 이야기는 그녀의 정점에서 시작된다.",
      popularity: 101.483,
    ...
    {
      adult: false,
      backdrop_path: "/4ojumOJv7MS4rMRhzgxbBoW0VrC.jpg",
      genre_ids: [35, 27],
      id: 852438,
      original_language: "fr",
      original_title: "Coupez !",
      overview:
